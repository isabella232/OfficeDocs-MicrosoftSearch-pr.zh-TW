...
|**角色**|**責任**|**部門**|
|:-----|:-----|:-----|
|執行發起人  <br/> |瞭解貴組織的 Microsoft 搜尋的高層遠景和價值。  <br/> 為 IT/業務小組提供領導支援。  <br/> 分配資源。  <br/> 直接與員工交流。  <br/> |執行領導  <br/> |
...
當您準備好時，允許組織中的所有使用者存取 Microsoft 搜尋，或使用分階段的方法來更緩慢地執行。 
...
3. 執行調查、焦點群組和意見反應，以瞭解使用者對 Microsoft 搜尋的看法、增加採用，以及識別改進區域。
    
教育和意見反應是具重複性的程序。 當您的使用者採用 Microsoft 搜尋時，可能需要變更內容和通訊。