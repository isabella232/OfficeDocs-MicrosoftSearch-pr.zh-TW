...
1. 在 Microsoft 365 系統管理中心內，移至 [設定]****  >  [Microsoft 搜尋]****。

**附註：** 如果您在 [設定]**** 下「未」看到 Microsoft 搜尋，請開啟任何系統管理中心頁面右上角的 [嘗試預覽版]**** 開關。
...
| SharePoint      | [規劃權限](https://docs.microsoft.com/sharepoint/plan-your-permissions-strategy)<br> [建立權限等級](https://docs.microsoft.com/sharepoint/how-to-create-and-edit-permission-levels)                          |
