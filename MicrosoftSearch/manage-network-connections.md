...
若要確定您和使用者可以連線到 Microsoft Search 端點，新增這些 Url 到您的防火牆允許清單。
  
## <a name="for-the-microsoft-search-admin-portal"></a>Microsoft 搜尋系統入口網站：
...
## <a name="for-microsoft-search-in-bing"></a>Microsoft Bing 搜尋：
